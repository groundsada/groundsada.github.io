  ...
  <div class="page-intro__inner">
    ...
    <div class="page-intro__content">
      ...
      <div class="social-icons">
        ...
        <a href="$GITHUB" target="_blank" title="GitHub" class="social-icon social-icon--github">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        ...
        <a href="$INSTAGRAM" target="_blank" title="Instagram" class="social-icon social-icon--instagram">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
