...
cat <<'EOF'
  <section class="about-section">
    ...
    <p>Before ESnet I was at the <strong>San Diego Supercomputer Center</strong> (UC San Diego): lead for the SEAM project, builder on the National Research Platform (NRP) Kubernetes substrate and its FABRIC integration, and developer of the SENSE Kubernetes operator. I'm also a three-PEARC-poster-and-paper person. Most recently PEARC '26 (<em>LLMs or Naive Bayes?</em>), and an instructor for SDSC's NRP courses.</p>
  </section>
